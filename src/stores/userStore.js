...
export const MODULES = ['order', 'planning', 'history', 'plan-fact', 'database', 'delivery-schedule', 'supplier-schedule', 'analytics', 'calendar', 'analysis', 'restaurant-sales', 'shelf-life', 'pricing', 'tenders', 'stock-collection', 'deficit', 'distribution', 'telegram', 'pallet-calc', 'cards', 'protocols', 'marketing', 'corrections', 'chat', 'pallet-storage', 'restaurant-orders', 'supplier-orders', 'truck-loading', 'surveys', 'tasks', 'dashboard', 'supply-assistant', 'keg-returns', 'reconciliation', 'tit-requests', 'analogs', 'novelties'];

export const ROLE_TEMPLATES = {
  admin:  { novelties: 'full', order: 'full', planning: 'full', history: 'full', 'plan-fact': 'full', database: 'full', 'delivery-schedule': 'full', 'supplier-schedule': 'full', analytics: 'full', calendar: 'full', analysis: 'full', 'restaurant-sales': 'full', 'shelf-life': 'full', pricing: 'full', tenders: 'full', 'stock-collection': 'full', deficit: 'full', distribution: 'full', telegram: 'full', 'pallet-calc': 'full', cards: 'full', protocols: 'full', marketing: 'full', corrections: 'full', chat: 'full', 'pallet-storage': 'full', 'restaurant-orders': 'full', 'supplier-orders': 'full', 'truck-loading': 'full', surveys: 'full', tasks: 'full', dashboard: 'full', 'supply-assistant': 'full', handover: 'full', 'own-production': 'full' },
  manager: { novelties: 'full', order: 'full', planning: 'full', history: 'full', 'plan-fact': 'full', database: 'full', 'delivery-schedule': 'full', 'supplier-schedule': 'full', analytics: 'full', calendar: 'full', analysis: 'full', 'restaurant-sales': 'full', 'shelf-life': 'full', pricing: 'full', tenders: 'full', 'stock-collection': 'full', deficit: 'full', distribution: 'full', telegram: 'none', 'pallet-calc': 'full', cards: 'full', protocols: 'full', marketing: 'full', corrections: 'full', chat: 'full', 'pallet-storage': 'full', 'restaurant-orders': 'full', 'supplier-orders': 'full', 'truck-loading': 'full', surveys: 'full', tasks: 'full', dashboard: 'full', 'supply-assistant': 'full', handover: 'full', 'own-production': 'full' },
  user:   { novelties: 'edit', order: 'edit', planning: 'edit', history: 'edit', 'plan-fact': 'edit', database: 'edit', 'delivery-schedule': 'edit', 'supplier-schedule': 'edit', analytics: 'view', calendar: 'view', analysis: 'edit', 'restaurant-sales': 'edit', 'shelf-life': 'edit', pricing: 'edit', tenders: 'edit', 'stock-collection': 'edit', deficit: 'edit', distribution: 'edit', telegram: 'none', 'pallet-calc': 'edit', cards: 'view', protocols: 'edit', marketing: 'view', corrections: 'view', chat: 'edit', 'pallet-storage': 'none', 'restaurant-orders': 'full', 'supplier-orders': 'full', 'truck-loading': 'none', surveys: 'edit', tasks: 'full', dashboard: 'none', 'supply-assistant': 'full', handover: 'edit' },
  viewer: { novelties: 'view', order: 'view', planning: 'view', history: 'view', 'plan-fact': 'view', database: 'view', 'delivery-schedule': 'view', 'supplier-schedule': 'view', analytics: 'view', calendar: 'view', analysis: 'view', 'restaurant-sales': 'view', 'shelf-life': 'view', pricing: 'view', tenders: 'view', 'stock-collection': 'view', deficit: 'view', distribution: 'view', telegram: 'none', 'pallet-calc': 'view', cards: 'view', protocols: 'view', marketing: 'none', corrections: 'none', chat: 'none', 'pallet-storage': 'none', 'restaurant-orders': 'view', 'supplier-orders': 'view', 'truck-loading': 'none', surveys: 'view', tasks: 'full', dashboard: 'none', 'supply-assistant': 'view', handover: 'view', 'own-production': 'view' },
};
  ...
  async function restoreSession() {
    ...
    _restorePromise = (async () => {
      ...
      try {
        ...
        if (data.user) {
          const updated = { ...stored, email: data.user.email || null, role: data.user.role, display_role: data.user.display_role, legal_entities: data.user.legal_entities, supplier_scope: data.user.supplier_scope || [], permissions: data.user.permissions || null, hidden_modules: data.user.hidden_modules || [] };
  ...
  async function validateSession() {
    try {
      ...
      if (data.user && currentUser.value) {
        const updated = { ...currentUser.value, email: data.user.email || null, role: data.user.role, display_role: data.user.display_role, legal_entities: data.user.legal_entities, supplier_scope: data.user.supplier_scope || [], permissions: data.user.permissions || null, hidden_modules: data.user.hidden_modules || [] };
        currentUser.value = updated;
        localStorage.setItem('bk_user', JSON.stringify(updated));
        return updated;
      }
