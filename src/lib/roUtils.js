...
export const STATUS_LABELS = {
  ...
  edited: 'Изменён',
  draft: 'Черновик',
  // locked — окно подачи закрылось, заявка ушла поставщику. Ресторан ничего
  // не нарушил, поэтому не «Заблокирован»: в истории это читалось как
  // наказание и пугало. На стороне закупок этот же статус давно зовётся
  // «День закрыт».
  locked: 'Приём закрыт',
};
