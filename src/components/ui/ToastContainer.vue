...
.toast--success { border-left-color:#34a853; } .toast--error { border-left-color:#ea4335; } .toast--warning { border-left-color:#F4A261; } .toast--info { border-left-color:#4285f4; }
...
.toast--success .toast-icon { background:#34a853; } .toast--error .toast-icon { background:#ea4335; } .toast--warning .toast-icon { background:#F4A261; } .toast--info .toast-icon { background:#4285f4; }
