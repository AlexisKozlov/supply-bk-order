...
function toggleAnalog(a) {
  // Намеренная мутация вложенного свойства props: родитель передаёт массив объектов по ссылке
  // и читает изменённые .checked при событии 'apply'. Это двусторонний контракт.
  a.checked = !a.checked;
}
