    ...
    <template v-else>
      ...
      <section class="ho-block">
        ...
        <p v-if="current.suppliers_stale" class="ho-warn">
          Список приходов разошёлся с заказами за период — пересоберите.
      ...
      <section class="ho-block">
        ...
        <p class="ho-block-hint">
          Только свои приходы: заказы за период, автор которых —
          <b>{{ current.doc.author_login || current.doc.author_name }}</b>. Допишите сроки корректировки
          и на что обратить внимание — это и есть самое ценное для того, кто вас заменяет.
        </p>
