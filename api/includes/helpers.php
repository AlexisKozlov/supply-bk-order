...
// Срок показа новинки по умолчанию (дней с даты появления товара в справочнике).
// Единый источник правды для портала, кабинета ресторана и бота.
...
$ROLE_TEMPLATES = [
    'admin' => ['novelties'=>'full','order'=>'full','planning'=>'full','history'=>'full','plan-fact'=>'full','database'=>'full','delivery-schedule'=>'full','supplier-schedule'=>'full','analytics'=>'full','calendar'=>'full','analysis'=>'full','restaurant-sales'=>'full','shelf-life'=>'full','pricing'=>'full','tenders'=>'full','stock-collection'=>'full','deficit'=>'full','distribution'=>'full','telegram'=>'full','pallet-calc'=>'full','pallet-storage'=>'full','cards'=>'full','corrections'=>'full','chat'=>'full','marketing'=>'full','protocols'=>'full','restaurant-orders'=>'full','supplier-orders'=>'full','truck-loading'=>'full','surveys'=>'full','tasks'=>'full','dashboard'=>'full','supply-assistant'=>'full','analogs'=>'full','handover'=>'full','own-production'=>'full'],
    'manager' => ['novelties'=>'full','order'=>'full','planning'=>'full','history'=>'full','plan-fact'=>'full','database'=>'full','delivery-schedule'=>'full','supplier-schedule'=>'full','analytics'=>'full','calendar'=>'full','analysis'=>'full','restaurant-sales'=>'full','shelf-life'=>'full','pricing'=>'full','tenders'=>'full','stock-collection'=>'full','deficit'=>'full','distribution'=>'full','telegram'=>'none','pallet-calc'=>'full','pallet-storage'=>'full','cards'=>'full','corrections'=>'full','chat'=>'full','marketing'=>'full','protocols'=>'full','restaurant-orders'=>'full','supplier-orders'=>'full','truck-loading'=>'full','surveys'=>'full','tasks'=>'full','dashboard'=>'full','supply-assistant'=>'full','analogs'=>'full','handover'=>'full','own-production'=>'full'],
    'user'  => ['novelties'=>'edit','order'=>'edit','planning'=>'edit','history'=>'edit','plan-fact'=>'edit','database'=>'edit','delivery-schedule'=>'edit','supplier-schedule'=>'edit','analytics'=>'view','calendar'=>'view','analysis'=>'edit','restaurant-sales'=>'edit','shelf-life'=>'edit','pricing'=>'edit','tenders'=>'edit','stock-collection'=>'edit','deficit'=>'edit','distribution'=>'edit','telegram'=>'none','pallet-calc'=>'edit','pallet-storage'=>'none','cards'=>'view','corrections'=>'edit','chat'=>'edit','marketing'=>'edit','protocols'=>'edit','restaurant-orders'=>'full','supplier-orders'=>'full','truck-loading'=>'none','surveys'=>'edit','tasks'=>'full','dashboard'=>'view','supply-assistant'=>'full','analogs'=>'full','handover'=>'edit','own-production'=>'edit'],
    'viewer' => ['novelties'=>'view','order'=>'view','planning'=>'view','history'=>'view','plan-fact'=>'view','database'=>'view','delivery-schedule'=>'view','supplier-schedule'=>'view','analytics'=>'view','calendar'=>'view','analysis'=>'view','restaurant-sales'=>'view','shelf-life'=>'view','pricing'=>'view','tenders'=>'view','stock-collection'=>'view','deficit'=>'view','distribution'=>'view','telegram'=>'none','pallet-calc'=>'view','pallet-storage'=>'none','cards'=>'view','corrections'=>'view','chat'=>'view','marketing'=>'view','protocols'=>'view','restaurant-orders'=>'view','supplier-orders'=>'view','truck-loading'=>'none','surveys'=>'view','tasks'=>'full','dashboard'=>'view','supply-assistant'=>'view','analogs'=>'view','handover'=>'view','own-production'=>'view'],
];
...
$TABLE_TO_MODULE = [
    ...
    'handover_docs'=>'handover','handover_people'=>'handover','handover_suppliers'=>'handover','handover_items'=>'handover',
...
// Общие справочники группы (products, suppliers). Колонка legal_entity_group
// в них проставляется триггером БД из legal_entity, так что приложению её
// заполнять не нужно.
//
// Почему отдельным списком, а не в $GROUP_TABLES: там для PATCH/DELETE без id
// СЕРВЕР ТРЕБУЕТ от клиента явный фильтр legal_entity_group, и все 14 мест
// сохранения справочника (карточка товара, импорт карточек, переименование
// группы аналогов, правка поставщика, ссылка на заказ в графике поставок,
// удаления) пришлось бы переписывать — с риском поймать 400 у обычного
// сотрудника там, где у админа всё работает. Здесь сервер вместо требования
// САМ дописывает условие «только мои группы» в WHERE: чужая карточка просто
// не попадает в выборку. Клиент менять не нужно.
//
// Без этого справочник вообще не фильтровался на сервере: сотрудник «Пицца
// Стар» обычным REST-запросом получал каталог «Бургер БК» и наоборот.
$DICT_GROUP_TABLES = ['products','suppliers'];
