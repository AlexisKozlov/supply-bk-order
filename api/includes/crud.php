...
$writeWhitelist = [
    ...
    'suppliers'    => ['id','short_name','full_name','legal_entity','legal_entity_group','is_active','dlt','doc','palletization','notes','schedule','whatsapp','telegram','viber','email','cc_emails','country','payment_delay_days'],
