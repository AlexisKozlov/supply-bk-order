...
Заявки по ПРЦ можно и править — количества, статус дня. Изменения сразу видят
рестораны и отдел закупок, поэтому меняйте только то, о чём договорились.
...
Вверху раздела несколько вкладок. Вам нужны две:

| Вкладка | Для чего |
|---|---|
| **Приём** | Главный экран: заявки на выбранный день, выгрузки и печать |
| **Список заявок** | Все заявки за период, если нужно найти конкретную |

Остальные вкладки — «Обзор», «Графики», «Шаблон товаров», «Настройки» — тоже
открыты, и всё в них относится только к ПРЦ. Менять там что-либо стоит по
согласованию с отделом закупок: график и шаблон товаров видят рестораны.
...
Да, по заявкам ПРЦ. Но лучше сначала согласовать с отделом закупок: ресторан
видит то же самое, и расхождение придётся объяснять.

**Могу ли я случайно задеть другого поставщика?**
Нет. Всё, что вы видите и меняете, относится только к ПРЦ.
