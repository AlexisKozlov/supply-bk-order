...
class QueryBuilder {
  ...
  select(c, o) {
    // Íîðìàëèçóåì: óáèðàåì ïåðåíîñû, ëèøíèå ïðîáåëû, ïðîáåë ïåðåä (
  ...
  async _run() {
    ...
    // or Ð¿ÐµÑ€ÐµÐ´Ð°Ñ‘Ð¼ Ð²Ñ€ÑƒÑ‡Ð½ÑƒÑŽ Ñ‡Ñ‚Ð¾Ð±Ñ‹ Ð½Ðµ Ð»Ð¾Ð¼Ð°Ñ‚ÑŒ ÐºÐ¾Ð´Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¸Ðµ Ð·Ð°Ð¿ÑÑ‚Ñ‹Ñ… Ð¸ ÑÐ¿ÐµÑ†ÑÐ¸Ð¼Ð²Ð¾Ð»Ð¾Ð²
    let qs = p.toString();
    if (this._or) {
